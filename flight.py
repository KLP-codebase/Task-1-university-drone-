...
# ============================================================================
# MAIN SCRIPT - Iris Flight Controller
# ============================================================================

if __name__ == "__main__":
    """
    Main script to execute Iris drone flight missions
    """
    
    print("\n" + "="*60)
    print("  IRIS DRONE FLIGHT CONTROLLER")
    print("="*60 + "\n")
    
    try:
        # Create DroneController instance
        print("Initializing connection to ArduPilot SITL...")
        controller = DroneController(sitl_ip="0.0.0.0", sitl_port=14550)
        print("✓ Successfully connected to SITL\n")
        
        # Execute Iris 2-meter mission
        print("Starting Iris 2-meter flight mission...")
        success = iris_mission_2m(controller, hover_duration=5)
